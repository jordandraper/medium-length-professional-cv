...
% Jordan Draper
%
% Change Detail: Added sublist command in the same formatting as parent list. Added social icon use and reference links. Added Skills & Interest section.
%
% Original author(s):
...
\address{(011)~$\cdot$~899~$\cdot$~9881 \\ john@LaTeXTemplates.com \\ \href{https://github.com/jordandraper}{\faGithubSquare}} % Contact information
...
%----------------------------------------------------------------------------------------
%	SOCIAL ICONS REFERENCE (https://mirrors.ibiblio.org/CTAN/fonts/fontawesome/doc/fontawesome.pdf)
%----------------------------------------------------------------------------------------
...
% 	{\bf Skills:} Problem solving; communication; public speaking; managing expectations\\
% 	{\bf Interests:} Coding; automation; learning new skills \\
